...
- Based on role, experience, projects, skills and resume
`,
      },
      {
        role: "user",
    ...
    const interview = await Interview.create({
      ...
      question: formattedQuestions, // schema field
    });
...
Score from 0 to 10 in:
Confidence
Communication
Correctness

finalScore = average of all.
...
`,
    ...
    try {
      ...
      parsed = {
        ...
        correctness: 5,
        finalScore: 5,
        feedback: "Decent answer but could be improved.",
      };
    }
...
export const getMyInterviews = async (req, res) => {
  try {
    ...
    return res.status(500).json({
      message: `failed to find current Interview ${error}`,
    });
  }
};
...
export const getInterviewReport = async (req, res) => {
  try {
    ...
    const avgCorrectness = totalQuestion
      ? totalCorrectness / totalQuestion
      : 0;
