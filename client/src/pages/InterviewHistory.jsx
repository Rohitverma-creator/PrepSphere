...
function InterviewHistory() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-pink-100 py-10">
        ...
        <div className="mb-10 w-full flex items-start gap-4 flex-wrap">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-2">
              Track your past interviews and perfomance reports.
            </p>
          </div>
        </div>
        {interviews.length === 0 ? (
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <span
                        className={`px-4 py-1 rounded-full text-xs font-medium ${item.status === "completed" ? "bg-emerald-100 text-emerald-700" : "bg-yellow-100 text-yellow-600"}`}
                      >
                        {item.status}
                      </span>
                    </div>
